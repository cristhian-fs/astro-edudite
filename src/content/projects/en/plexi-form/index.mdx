---
name: 'PlexiForm'
description: 'Dynamic form that generates a parameterized URL to create a commercial proposal from an Elementor template.'
...
<div class="flex gap-4 flex-wrap justify-center [&_img,p]:m-0">
  <div class="max-w-xs">
    ![Form preview](../../../../../public/static/projects/plexi-form/form-view.webp)
  </div>
  <div class="max-w-xs">
    ![Live preview](../../../../../public/static/projects/plexi-form/live-preview.webp)
  </div>
</div>
